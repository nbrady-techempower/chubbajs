...
function _int(target, key, descriptor) {
  var col = createColumnInHash(target.constructor.name, key);
  col.colType = "INT";
  col.udtName = "int4";
  col.driverType = "int";
...
function _boolean(target, key, descriptor) {
  var col = createColumnInHash(target.constructor.name, key);
  col.colType = "BOOLEAN";
  col.udtName = "bool";
...
function varChar(value) {
  return function _(target, key, descriptor) {
    var col = createColumnInHash(target.constructor.name, key);
    col.colType = "VARCHAR(".concat(value, ")");
    col.udtName = "varchar";
...
var tableHash$1 = _annotations.tableHash;
...
function () {
  function Model(id) {
    ...
    this.model = tableHash$1[this.tableName];
      ...
      return regeneratorRuntime.async(function getById$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(exports.pool.query("SELECT * FROM \"".concat(this.tableName, "\" WHERE id = $1::int"), [id]));
            ...
            case 2:
              ...
              Object.keys(this.model.columns).forEach(function (k) {
                _this[k] = res.rows[0][k];
              });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              colKeysToSave = Object.keys(this.model.columns).filter(function (k) {
                return k !== "id" && typeof _this2[k] !== "undefined";
              });
              ...
              updateStr = "UPDATE \"".concat(this.tableName, "\" SET ");
              updateStr += colKeysToSave.map(function (k, i) {
                return "\"".concat(k, "\" = $").concat(i + 1, "::") + _this2.model.columns[k].driverType;
              }).join(",");
              updateStr += " WHERE id = $".concat(colKeysToSave.length + 1, "::int");
...
var isValidDatabaseId = function isValidDatabaseId(value) {
...
var validate = function validate(ctx, validateParams) {
  var req, sanitizedValues, hardFail, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, rules, key, value, validationType, msg, _validate, sanitize, failed, _value, _value2;
  ...
  return regeneratorRuntime.async(function validate$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          req = ctx.req;
          sanitizedValues = {}, hardFail = false;
        ...
        case 4:
          ...
          _context.prev = 7;
          _iterator = validateParams[Symbol.iterator]();
        ...
        case 9:
          ...
          validationType = rules.type;
          msg = rules.msg, _validate = rules.validate, sanitize = rules.sanitize;
          /**
        ...
        case 45:
          ...
          if ((_value = value) === null || _value === void 0 ? void 0 : _value.match(rules.regex)) {
            _context.next = 50;
            break;
          }
        ...
        case 50:
          ...
          if ((_value2 = value) === null || _value2 === void 0 ? void 0 : _value2.match(/^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$/)) {
            _context.next = 55;
            break;
          }
  ...
  }, null, null, [[7, 61, 65, 73], [16, 20], [66,, 68, 72]]);
};
...
function () {
  function RouteContext(req, res, next) {
    _classCallCheck(this, RouteContext);

    this.req = req;
    this.res = res;
    this.next = next; // This is reset after every controller
  ...
  _createClass(RouteContext, [{
    key: "addError",
    value: function addError(msgs) {
      var _this = this;
    ...
    key: "addSuccess",
    value: function addSuccess(msgs) {
      var _this2 = this;

      if (!Array.isArray(msgs)) msgs = [msgs];
      msgs.forEach(function (msg) {
        _this2.data.messages.push({
          msg: msg,
          type: "success"
        });
      });
    ...
    key: "isLoggedIn",
    get: function get() {// TODO: implement
    }
  }]);
...
var ValidationTypes$1 = validate$1.ValidationTypes,
    validate$2 = validate$1.validate;
/**
...
function createRoute(httpVerb, path, descriptor) {
  ...
  var wrappedController = function wrappedController(req, res, next) {
    var ctx, sanitizedValues, validated;
    return regeneratorRuntime.async(function wrappedController$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            // Set up a context object that will live through the request
            // if it doesn't already exist
            ctx = req.__ctx || new RouteContext(req, res, next);
            req.__ctx = ctx; // reset before every controller is called

            ctx.controllerErrors = false; // if @skipIfUnauthorized, go to next() right away
            ...
            return _context.abrupt("return", processNextController(ctx));
          ...
          case 5:
            ...
            _context.next = 8;
            return regeneratorRuntime.awrap(validate$2(ctx, fn.validateParams));
          ...
          case 12:
            ...
            _context.next = 15;
            return regeneratorRuntime.awrap(fn(ctx, sanitizedValues));
          ...
          case 16:
            ...
            _context.prev = 17;
            _context.next = 20;
            return regeneratorRuntime.awrap(context.pool);

          case 20:
            ctx.db = _context.sent;
            _context.next = 23;
            return regeneratorRuntime.awrap(fn(ctx, sanitizedValues));
          ...
          case 25:
            ...
            console.log("Something went wrong with in ".concat(path, ": ").concat(_context.t0.message));
          ...
          case 30:
            _context.next = 32;
            return regeneratorRuntime.awrap(context.pool.connect());

          case 32:
            ctx.db = _context.sent;
            _context.prev = 33;
            _context.next = 36;
            return regeneratorRuntime.awrap(ctx.db.query("BEGIN"));
          ...
          case 38:
            ...
            _context.next = 41;
            return regeneratorRuntime.awrap(ctx.db.query("ROLLBACK"));
          ...
          case 43:
            _context.next = 45;
            return regeneratorRuntime.awrap(ctx.db.query("COMMIT"));
          ...
          case 52:
            ...
            console.log("Something went wrong with in ".concat(path, ": ").concat(_context.t1.message));
...
var annotations = {
  ...
  skipIfUnauthorized: skipIfUnauthorized,
  validateParams: validateParams,
  ValidationTypes: ValidationTypes$1
};
...
var tableHash$2 = _annotations.tableHash;
function loadModels (config, pool) {
  processModels(config);

  function createColSqlStr(tableName, colName) {
    var col = tableHash$2[tableName].columns[colName];
    var sqlStr = "\"".concat(colName, "\" ").concat(col.colType);
    ...
    if (col.defaultValue !== null) {
      sqlStr += " DEFAULT ".concat(col.defaultValue);
    }
  ...
  function createTable(tableName) {
    ...
    var sqlStr = "CREATE TABLE \"".concat(tableName, "\" ( ");
    var colNames = Object.keys(tableHash$2[tableName].columns);
  ...
  function alterTable(tableName) {
    var res, colHash, currColumns, colNames, _i, _colNames, colName, modelCol, dbCol, sqlStr, _sqlStr, _sqlStr2, _sqlStr3;

    return regeneratorRuntime.async(function alterTable$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
          ...
          case 2:
            res = _context.sent;
            colHash = {};
            res.rows.forEach(function (col) {
              colHash[col.column_name] = col;
            });
            currColumns = Object.keys(colHash);
            colNames = Object.keys(tableHash$2[tableName].columns);
            _i = 0, _colNames = colNames;

          case 8:
            if (!(_i < _colNames.length)) {
              _context.next = 39;
              break;
            }

            colName = _colNames[_i];
            ...
            modelCol = tableHash$2[tableName].columns[colName];
            dbCol = colHash[colName]; // Check for type change
            ...
            console.log("\"".concat(tableName, "\".\"").concat(colName, "\" type has changed."));
            sqlStr = "ALTER TABLE \"".concat(tableName, "\" ALTER COLUMN \"").concat(colName, "\" ");
            sqlStr += "TYPE ".concat(modelCol.colType);
            _context.next = 19;
            return regeneratorRuntime.awrap(pool.query(sqlStr));
          ...
          case 19:
            ...
            console.log("\"".concat(tableName, "\".\"").concat(colName, "\" nullable has changed."));
            _sqlStr = "ALTER TABLE \"".concat(tableName, "\" ALTER COLUMN \"").concat(colName, "\" ");
            _sqlStr += modelCol.notNull ? "SET NOT NULL" : "DROP NOT NULL";
            _context.next = 25;
            return regeneratorRuntime.awrap(pool.query(_sqlStr));
          ...
          case 25:
            ...
            console.log("\"".concat(tableName, "\".\"").concat(colName, "\" default value changed."));
            _sqlStr2 = "ALTER TABLE \"".concat(tableName, "\" ALTER COLUMN \"").concat(colName, "\" ");
            _sqlStr2 += "SET DEFAULT ".concat(modelCol.defaultValue);
            _context.next = 31;
            return regeneratorRuntime.awrap(pool.query(_sqlStr2));
          ...
          case 33:
            _sqlStr3 = "ALTER TABLE \"".concat(tableName, "\" ADD ").concat(createColSqlStr(tableName, colName));
            _context.next = 36;
            return regeneratorRuntime.awrap(pool.query(_sqlStr3));
    ...
    return regeneratorRuntime.async(function runMigrations$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            res = _context2.sent;
            currTables = res.rows.map(function (table) {
              return table.table_name;
            });
            _context2.t0 = regeneratorRuntime.keys(tableHash$2);
          ...
          case 5:
            ...
            console.log("Table \"".concat(tableName, "\" already exists. Checking columns."));
            _context2.next = 11;
            return regeneratorRuntime.awrap(alterTable(tableName));
  ...
  if (config.database.migrations) {
    console.log(chalk$1.blue("===> Starting migrations..."));
    runMigrations();
  } else {
    console.log(chalk$1.blue("===> Skipping migrations... Done."));
  }
}
        ...
        case 0:
          try {
            exports.pool = new Pool({
              connectionString: "postgres://".concat(config.database.user, ":").concat(config.database.password, "@").concat(config.database.host, ":").concat(config.database.port, "/").concat(config.database.database)
            });
          } catch (e) {
            console.log(chalk$3.red("Database connection failed."));
            console.log(chalk$3.red(e));
          }

          console.log(chalk$3.blue("===> Done."));
          /** Load all of our Models / Run migrations **/

          loadModels(config, exports.pool);
          /** Load all of our Controllers **/

          loadControllers(config);
          context.pool = exports.pool;

...
var extendNode = function(iconv) {
  ...
  iconv.extendNodeEncodings = function extendNodeEncodings() {
    ...
    Buffer$8.isEncoding = function(encoding) {
      return (
        Buffer$8.isNativeEncoding(encoding) || iconv.encodingExists(encoding)
      );
    };
...
function readStream(stream, encoding, length, limit, callback) {
  ...
  if (limit !== null && length !== null && length > limit) {
    return done(
      httpErrors(413, "request entity too large", {
        expected: length,
        length: length,
        limit: limit,
  ...
  if (stream._decoder || (state && (state.encoding || state.decoder))) {
    // developer error
    return done(
      httpErrors(500, "stream encoding should not be set", {
  ...
  function onAborted() {
    if (complete) return;
      ...
      httpErrors(400, "request aborted", {
        code: "ECONNABORTED",
        expected: length,
        length: length,
        received: received,
  ...
  function onEnd(err) {
    ...
    if (length !== null && received !== length) {
        ...
        httpErrors(400, "request size did not match content length", {
          expected: length,
          length: length,
          received: received,
...
function read(req, res, next, parse, debug, options) {
  ...
  if (
    opts.encoding === null &&
    encoding !== null &&
    !lib.encodingExists(encoding)
  ) {
    return next(
      httpErrors(415, 'unsupported charset "' + encoding.toUpperCase() + '"', {
...
function json(options) {
  ...
  return function jsonParser(req, res, next) {
    ...
    if (charset.substr(0, 4) !== "utf-") {
      ...
      next(
        httpErrors(415, 'unsupported charset "' + charset.toUpperCase() + '"', {
          charset: charset,
          type: "charset.unsupported"
        })
      );
      ...
      },
      {
        ...
        value: function save() {
          ...
          var colKeysToSave,
            ...
            insertStr;
          return regeneratorRuntime.async(
            function save$(_context2) {
              while (1) {
                switch ((_context2.prev = _context2.next)) {
                  case 0:
                    // These are all the keys that need to be saved
                    colKeysToSave = Object.keys(this.model.columns).filter(
                      function(k) {
                    ...
                    updateStr += colKeysToSave
                      .map(function(k, i) {
                        return (
                          '"'.concat(k, '" = $').concat(i + 1, "::") +
                          _this2.model.columns[k].driverType
                        );
                      })
                      .join(",");
                    updateStr += " WHERE id = $".concat(
                      colKeysToSave.length + 1,
                      "::int"
                    );
                    colValsToSave.push(this.id);
                    _context2.next = 9;
                    return regeneratorRuntime.awrap(
                      exports.pool.query(updateStr, colValsToSave)
                    );
                  ...
                  case 11:
                    ...
                    colStr = colKeysToSave
                      .map(function(k) {
                        return '"'.concat(k, '"');
                      })
                      .join(",");
                    valStr = colKeysToSave
                      .map(function(k, i) {
                        return (
                          "$".concat(i + 1, "::") +
                          _this2.model.columns[k].driverType
                    ...
                    insertStr = 'INSERT INTO "'
                      ...
                      .concat(colStr, ") VALUES (")
                      .concat(valStr, ")");
                    console.log(insertStr);
                    _context2.next = 17;
                    return regeneratorRuntime.awrap(
                      exports.pool.query(insertStr, colValsToSave)
                    );
      ...
      while (1) {
        switch ((_context.prev = _context.next)) {
          ...
          case 20:
            ...
            ctx.log.tamper(
              "Custom sanitization failed for ".concat(key, ": ").concat(value)
            );
            hardFail = true;
          ...
          case 26:
            ...
            ctx.log.tamper("Custom validation failed: ".concat(value));
            hardFail = true;
            return _context.abrupt("break", 63);
          ...
          case 31:
            ...
            ctx.log.tamper(
              ""
                .concat(ValidationTypes.databaseId, " validation failed: ")
                .concat(value)
            );
            hardFail = true;
            return _context.abrupt("break", 63);
          ...
          case 38:
            ...
            if (validationType === ValidationTypes.enforcePositive) {
              if (!value || isNaN(parseInt(value)) || value <= 0) {
                ctx.log.tamper(
                  ""
                    .concat(
                      ValidationTypes.enforcePositive,
                      " validation failed: "
                    )
                    .concat(value)
                );
            ...
            if (validationType === ValidationTypes.enforcePositiveInt) {
              if (!value || isNaN(parseInt(value)) || value <= 0) {
                ctx.log.tamper(
                  ""
                    .concat(
                      ValidationTypes.enforcePositiveInt,
                      " validation failed: "
                    )
                    .concat(value)
                );
            ...
            ctx.log.tamper(
              ""
                .concat(ValidationTypes.enforcePositive, " validation failed: ")
                .concat(value)
            );
            hardFail = true;
            return _context.abrupt("break", 63);
          ...
          case 54:
            ...
            if (
              (_value2 = value) === null || _value2 === void 0
                ? void 0
                : _value2.match(/^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$/)
            ) {
              _context.next = 59;
              break;
            }
...
function createRoute(httpVerb, path, descriptor) {
  ...
  var wrappedController = function wrappedController(req, res, next) {
    ...
    return regeneratorRuntime.async(
      function wrappedController$(_context) {
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
            ...
            case 5:
              ...
              _context.next = 8;
              return regeneratorRuntime.awrap(
                validate$2(ctx, fn.validateParams)
              );
...
var processModels = function(config) {
  ...
  var pathToModels = config.projectRoot
      ...
      while (1) {
        switch ((_context.prev = _context.next)) {
          case 0:
            ...
            return regeneratorRuntime.awrap(
              pool.query(
                "\n    SELECT * FROM information_schema.columns\n    WHERE table_schema = 'public' and table_name = '".concat(
                  tableName,
                  "';\n  "
                )
              )
          ...
          case 8:
            ...
            console.log(
              '"'
                .concat(tableName, '"."')
                .concat(colName, '" type has changed.')
            );
            sqlStr = 'ALTER TABLE "'
              .concat(tableName, '" ALTER COLUMN "')
              .concat(colName, '" ');
          ...
          case 19:
            ...
            console.log(
              '"'
                .concat(tableName, '"."')
                .concat(colName, '" nullable has changed.')
            );
            _sqlStr = 'ALTER TABLE "'
              .concat(tableName, '" ALTER COLUMN "')
              .concat(colName, '" ');
          ...
          case 25:
            ...
            console.log(
              '"'
                .concat(tableName, '"."')
                .concat(colName, '" default value changed.')
            );
            _sqlStr2 = 'ALTER TABLE "'
              .concat(tableName, '" ALTER COLUMN "')
              .concat(colName, '" ');
          ...
          case 33:
            _sqlStr3 = 'ALTER TABLE "'
              .concat(tableName, '" ADD ')
              .concat(createColSqlStr(tableName, colName));
            _context.next = 36;
      ...
      while (1) {
        switch ((_context2.prev = _context2.next)) {
          ...
          case 5:
            ...
            console.log(
              'Table "'.concat(tableName, '" already exists. Checking columns.')
            );
            _context2.next = 11;
...
var loadControllers = function(config) {
  ...
  var pathToControllers = config.projectRoot
          ...
          try {
            exports.pool = new Pool({
              connectionString: "postgres://"
                .concat(config.database.user, ":")
                .concat(config.database.password, "@")
                .concat(config.database.host, ":")
                .concat(config.database.port, "/")
                .concat(config.database.database)
            });
          } catch (e) {
